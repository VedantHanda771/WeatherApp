...
async function getData(city) {
    // Update URL to your deployed Vercel link
    let url = `https://weather-app-three-sandy-94.vercel.app/api/weather/${city}`;
...
async function getLocationBysrch(data) {
    ...
    // Update URL to your deployed Vercel link
    let urlDays = `https://weather-app-three-sandy-94.vercel.app/api/forecast/${lat}/${long}`;
...
async function liveLocationD(lat, long) {
    try {
        ...
        let weatherUrl = `https://weather-app-three-sandy-94.vercel.app/api/weather/${lat},${long}`;
        let weatherRes = await fetch(weatherUrl);
        let weatherData = await weatherRes.json();

        // Get forecast data
        let forecastUrl = `https://weather-app-three-sandy-94.vercel.app/api/forecast/${lat}/${long}`;
